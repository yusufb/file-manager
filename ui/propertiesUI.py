...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tagLabelValue = QtGui.QLabel(self.layoutWidget1)
        self.tagLabelValue.setObjectName(_fromUtf8("tagLabelValue"))
        self.verticalLayout_2.addWidget(self.tagLabelValue)
    ...
    def retranslateUi(self, Form):
        ...
        self.tagLabelValue.setText(_translate("Form", "TextLabel", None))
