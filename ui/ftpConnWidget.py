...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(210, 220)
        Form.setMinimumSize(QtCore.QSize(210, 220))
        Form.setMaximumSize(QtCore.QSize(210, 220))
        self.hostTxt = QtGui.QLineEdit(Form)
        self.hostTxt.setGeometry(QtCore.QRect(80, 20, 113, 20))
        self.hostTxt.setObjectName(_fromUtf8("hostTxt"))
        self.portTxt = QtGui.QLineEdit(Form)
        self.portTxt.setGeometry(QtCore.QRect(80, 50, 113, 20))
        self.portTxt.setObjectName(_fromUtf8("portTxt"))
        self.usernameTxt = QtGui.QLineEdit(Form)
        self.usernameTxt.setGeometry(QtCore.QRect(80, 80, 113, 20))
        ...
        self.passwordTxt.setGeometry(QtCore.QRect(80, 110, 113, 20))
        ...
        self.label_3.setGeometry(QtCore.QRect(20, 80, 53, 13))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.label_4 = QtGui.QLabel(Form)
        self.label_4.setGeometry(QtCore.QRect(20, 112, 52, 13))
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.connectButton = QtGui.QPushButton(Form)
        self.connectButton.setGeometry(QtCore.QRect(18, 160, 81, 23))
        self.connectButton.setObjectName(_fromUtf8("connectButton"))
        self.cancelButton = QtGui.QPushButton(Form)
        self.cancelButton.setGeometry(QtCore.QRect(110, 160, 81, 23))
